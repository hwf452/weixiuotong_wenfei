...
public class My_Repair_Order_Repair_Now extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.my_repair_order_repair_now);
		...
		handler = new Handler() {
			public void handleMessage(android.os.Message msg) {
				...
				case GETORDER_STATUS:
					...
					Toast.makeText(My_Repair_Order_Repair_Now.this,
