...
public class Repair_Detail_Activity extends Activity implements OnClickListener {

	private Button btn1, btn2, btn3, btn5;
		...
		handler = new Handler() {
			public void handleMessage(android.os.Message msg) {
				...
				case GETORDER_STATUS:
					...
					Toast.makeText(Repair_Detail_Activity.this,
	...
	public void onClick(View v) {
		...
		case R.id.button2:
			Intent intent2 = new Intent(this, Edit_RepairOrder_Activity.class);
			intent2.putExtra("subNum", subNum);
